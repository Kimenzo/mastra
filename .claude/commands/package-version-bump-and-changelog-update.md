...
- Update .changeset/pre.json to enter/exit prerelease mode or mark a version bump.
- Update package.json and CHANGELOG.md files for many packages (client, server, adapters, observability, etc).
