...
- Update .changeset/pre.json to enter/exit prerelease or mark a new version.
- Update package.json and CHANGELOG.md for each affected package.
- Optionally, add or update .changeset/*.md files with release notes.
