...
- Updated workspace tool discovery to use `createWorkspaceTools` from core for accurate runtime detection of available tools (e.g. `ast_edit` requires `@ast-grep/napi`). ([#13233](https://github.com/mastra-ai/mastra/pull/13233))
